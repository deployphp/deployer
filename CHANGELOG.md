...
### Fixed
- Fixed shared recipe bug described in [#1593] shared ignores changes pulled from git in release shared folders [#1593]: https://github.com/deployphp/deployer/pull/1593
