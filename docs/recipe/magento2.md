...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L52)
...
### shared_dirs
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L79)
...
WARNING: Do not use [bin/magento](/docs/recipe/magento2.md#bin/magento) in deploy:failed handlers - release_or_current_path points to the failed
release during failure, not the live one. Use [current_path](/docs/recipe/common.md#current_path) explicitly instead.
...
### config_import_needed_on_current
...
This task is group task which contains next tasks:
* [magento:config:import:on-current](/docs/recipe/magento2.md#magento-config-import-on-current)
* [magento:maintenance:disable](/docs/recipe/magento2.md#magento-maintenance-disable)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L467)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L472)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L524)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L579)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L611)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L617)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L630)
...
[Source](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php#L639)
