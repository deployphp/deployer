...
task('deploy:prepare', function () {
    ...
    if ($result) {
        throw new Exception('There already is a directory (not symlink) named "' . get('current') . '" in ' . get('deploy_path') . '. Remove this directory so it can be replaced with a symlink for atomic deployments.');
    }
